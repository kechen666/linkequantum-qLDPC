...
N_Qubit_List = [10, 20, 30, 40, 50, 60, 80, 100]
NAOD_list = [1, 2, 3, 4]
I_List = range(10)
...
with open("data/qaoa_regular6_storage_compare_multi_aod.txt", 'w') as file:
    ...
    for NAOD in NAOD_list:
        ...
        for n in N_Qubit_List:
            ...
            path = f"benchmarks/qaoa/{type}/q{n}_regular6/i{index}.txt"
